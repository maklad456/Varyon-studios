  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-white/5 bg-[#020202]/70 backdrop-blur-xl">
      <div className="mx-auto flex w-full items-center justify-between px-6 py-5 text-white sm:px-8 lg:px-12">
        ...
        <nav className="hidden items-center justify-center gap-10 text-base font-medium tracking-wide md:flex">
          {navItems.map((item) => (
            <button
              key={item.href}
              type="button"
        ...
        <div className="hidden items-center justify-end gap-4 md:flex">
          <a
            ...
            className="rounded-full bg-vs-accent px-6 py-3 text-[11px] font-semibold uppercase leading-tight tracking-[0.2em] text-black transition hover:bg-emerald-500 text-center"
          >
