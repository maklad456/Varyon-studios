...
export function SiteFooter() {
  return (
    <footer className="border-t border-white/50 bg-black text-white">
      {/* Mobile: Logo on top, then text, then links */}
        ...
        <div className="mt-8 space-y-6">
          ...
          <div>
            ...
            <div className="mt-4 space-y-4 text-sm leading-relaxed text-white/80">
              ...
              <div className="mt-4">
                <a
                  href="https://www.instagram.com/varyonstudios?igsh=MTlob29uOTdnaHQ1bQ%3D%3D&utm_source=qr"
                  target="_blank"
                  rel="noreferrer"
      ...
      <div className="site-container hidden gap-8 py-6 md:grid md:grid-cols-3">
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.3em] text-vs-accent-soft">Quick links</p>
            <ul className="mt-4 space-y-4 text-sm text-white/80">
            {quickLinks.map((link) => (
